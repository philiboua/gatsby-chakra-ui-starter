...
export const Billboard: React.FC<BillBoardProps> = ({
  ...
  const billboardContent = getChildByType(children, "body")
  const billboardMedia = getChildByType(children, "media")
  const billboardFooter = getChildByType(children, "footer")
  const billboardBg = getChildByType(children, "background")
