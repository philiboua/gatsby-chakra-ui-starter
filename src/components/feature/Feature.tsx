...
export const Feature: React.FC<FeatureProps> = ({
  ...
  let featureMedia: React.ReactNode
  let featureContent: React.ReactNode

  if (children) {
    featureMedia = getChildByType(children, "media")
    featureContent = getChildByType(children, "body")
  }
