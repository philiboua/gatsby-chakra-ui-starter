...
Video.mouseEnter() // we trigger this action on mouseEnter event
Video.mouseLeave() // we trigger this action on mouseLeave event
```
...
<Canvas>
  <Story name="Video Template Alpha">
    <VideoBox
      ...
      height="500px"
      width="300px"
      videoBorderRadius="20px 20px 0px 0px"
    >
      <videoContext.Consumer>
        {context => {
