...
import * as Video from "@components/videoBox/reducer/videoActionCreators"
...
1. import the VideoBox context and its action creator
...
1. consume the context inside the videoBox to have access to the dispatcher funciton and the state coming from useReducer
...
```javascript
<VideoBox loop videoMp4SrcURL={video} height="500px" width="300px">
  <videoContext.Consumer>
    {context => {
